    ...
    >
            ...
            <motion.div
              ...
              className={`absolute ${
                item === middleItem
                  ...
                  : "text-neutral-900 dark:text-neutral-300 font-semibold text-lg"
      ...
      {message && (
        <motion.div
          ...
          } text-center text-sm absolute bottom-32 left-1/2 transform -translate-x-1/2 p-4 rounded-xl`}
        >
          {message}
        </motion.div>
      )}
      ...
      {combination.length > 0 && 
        <div className="absolute left-1/2 transform -translate-x-1/2 bg-white border dark:bg-transparent border-neutral-100 dark:border-neutral-800 p-2 rounded-lg">
        <div className="flex space-x-5 items-center justify-center px-2">
