...
export default function Disk() {
  ...
  return (
    <main className="py-6">
      <HeaderDetails title="Album Disk" date="Nov, 2024" />
      <article className="mt-10 max-w-none">
      <p className="text-[14.5px] leading-7 text-neutral-600 dark:text-neutral-400 [&:not(:first-child)]:mt-6">          Um componente estilizado que simula a exibição de um disco de álbum,
          perfeito para sites de música ou galerias de mídia.
        </p>
          ...
          <div className="flex min-h-[500px] flex-col items-center justify-center gap-8">
            <div className="relative flex items-center justify-center">
              <motion.div
                ...
                className="group relative z-10 h-56 w-60 cursor-pointer overflow-hidden rounded-md shadow-lg shadow-neutral-800/50"
                onClick={show}
              >
                <img
                  src="/images/bg.png"
                ...
                />
                <motion.div className="absolute inset-0  transition-opacity duration-300 group-hover:from-black/0 group-hover:via-black/20 group-hover:to-black/60"></motion.div>
                <div
                ...
                />
                <div className="relative flex h-full flex-col justify-end p-6 text-neutral-100">
                  <p className="select-none text-sm opacity-90 drop-shadow-md">
                    The big GOAT
                  </p>
                </div>
              </motion.div>
              <motion.div
                ...
                className={`group absolute -mb-7 h-40 w-40 overflow-hidden rounded-full shadow-xl transition-transform duration-500 hover:rotate-12`}
              >
                <div className="relative flex h-full w-full items-center justify-center rounded-full bg-black">
                  ...
                  ></div>
                  <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full bg-neutral-600">
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: 30 }}
              className=" -mt-10 flex max-w-[360px] flex-col items-center justify-center gap-y-3"
            >
              ...
              <span className="text-center text-xs text-neutral-400">
                The latest exploration of The Big Goat, a journey immersed in
                tones and textures that explore the beauty of the simple.
              </span>
            </motion.div>
          </div>
        </Preview>
