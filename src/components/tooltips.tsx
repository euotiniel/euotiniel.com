...
export default function Tooltip({ text, children, className }: TooltipProps) {
  ...
  return (
    ...
    >
      <motion.div
        className={cn(
          "absolute -top-4 left-1/2 whitespace-nowrap rounded-md border border-neutral-300 bg-neutral-50/20 [translate:-50%_-50%]",
          "px-2 py-1 text-xs text-black dark:border-[#262626a4] dark:bg-neutral-900/25 dark:text-white",
          className,
        )}
