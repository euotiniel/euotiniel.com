            ...
            <div className="flex w-full flex-col">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="text-[13.8px] leading-none text-neutral-800 dark:text-neutral-300">
                    {experience.role} at
                  </span>
                ...
                <span className="text-[12.5px] leading-none text-neutral-800 dark:text-neutral-400">
                  {experience.period}
                </span>
              </div>
            </div>
