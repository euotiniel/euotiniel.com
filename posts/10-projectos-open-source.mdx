...
<ul className="flex flex-col gap-3 mt-5" style={{ listStyle: 'disc', marginLeft: '20px'}}>
    <li className="text-[14.9px]">GNU/Linux;</li>
    <li className="text-[14.9px]">Android;</li>
    <li className="text-[14.9px]">Electron;</li>
    <li className="text-[14.9px]">MySQL;</li>
    <li className="text-[14.9px]">Git;</li>
    <li className="text-[14.9px]">Node.js;</li>
    <li className="text-[14.9px]">Vue.js;</li>
    <li className="text-[14.9px]">Docker;</li>
    <li className="text-[14.9px]">Kubernetes;</li>
    <li className="text-[14.9px]">TensorFlow.</li>
</ul>
