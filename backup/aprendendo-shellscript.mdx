...
<ul className="flex flex-col gap-3 mt-5 text-[14.9px]" style={{ listStyle: 'disc', marginLeft: '20px'}}>
    ...
    <li><a href="https://www.linkedin.com/in/sabaoth-miguel-93a204210/" className="border-b transition-all text-gray-500 duration-500 hover:border-gray-500" target="_blank">Sabaoth Miguel</a>;</li>
