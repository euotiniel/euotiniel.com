export const metadata = {
  title: 'Notas sobre affordance',
  date: '2025.09.17',
  description:
    'Explorando o conceito de affordance no design web, analisando como diferentes tipos de affordances influenciam a interação do usuário',
  slug: 'affordance-and-interface-perception',
}
...
Durante minha pesquisa sobre os detalhes que tornam uma interação mais fluida, encontrei o artigo ["Invisible Details of Interaction Design" de Rauno Freiberg](https://rauno.me/craft/interaction-design), onde tive o meu primeiro contacto consciete com a palavra, o artigo aborda aspectos muitas vezes negligenciados, mas essenciais.
...
1. Affordance
2. O que é Affordance e como projetar pensando nisso
3. Detalhes invisíveis do design de interação
4. What Are Affordances in Web Design?