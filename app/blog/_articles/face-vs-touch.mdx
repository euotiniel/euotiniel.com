export const metadata = {
  title: 'Face ID VS Touch ID',
  date: '2025.06.04',
  description:
    'Opinião sobre os dois métodos de autenticação da Apple, comparando segurança, usabilidade e experiência do usuário',
  slug: 'face-id-vs-touch-id',
}
...
![Sondagem: Touch vs Face](/blog/touch-vs-face.jpg)
